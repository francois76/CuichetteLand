   ...
   public function categoriesAction($categorie)
    {
        ...
        return $this->render('CuichetteLandwebsiteBundle:Default:categories.html.twig', array('names' => $names, 'images' => $images, 'description' => $descriptions, 'categorie' => $categorie, 'products' => $products));
    }
